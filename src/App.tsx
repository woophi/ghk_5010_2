...
export const App = () => {
  ...
  const submit = () => {
    window.gtag('event', '5010_accept_var2');
    setLoading(true);
  ...
  return (
    <>
      <div className={appSt.container}>
        ...
        <div>
          <div className={appSt.rowText} onClick={() => window.gtag('event', '5010_FAQ_var2')}>
            <CDNIcon name="glyph_question-circle_m" />
            <Typography.Text view="primary-medium">Частые вопросы</Typography.Text>
          </div>
          <div className={appSt.rowText} onClick={() => window.gtag('event', '5010_moreinfo_var2')}>
        ...
        <Typography.Text view="primary-small" color="secondary">
          ...
          <span style={{ textDecoration: 'underline' }} onClick={() => window.gtag('event', '5010_newinfo_var2')}>
